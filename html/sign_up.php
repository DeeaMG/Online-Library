...
<html lang="en">
    ...
    <body>
		<div class="page">
            ...
            <main>
				...
				<div class="title">Inregistrare</div>
                    <form class="orderContent" action="../php_includes/sign_up_include.php" method="POST">
						<label class="info-log"><i class="fas fa-user"></i> Full Name <span class="asterisk">*</span></label>
						<input type="text" id="fullName" placeholder="Enter your user name" class="input-log" required="" name="username">
						
						<label class="info-log"><i class="fas fa-envelope"></i> Email <span class="asterisk">*</span></label>
						<input type="email" id="email" placeholder="name@example.com" class="input-log" required="" name="mail">
						
						<label class="info-log"><i class="fas fa-lock"></i> Password <span class="asterisk">*</span></label>
						<input type="password" id="password1" placeholder="********" class="input-log" name="pass"
							   required="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
							   title="You must introduce 8 characters containing lower case, upper case and numbers for a more secure password.">
						
						<label class="info-log"><i class="fas fa-lock"></i> Confirm Password <span class="asterisk">*</span></label>
						<input type="password" id="password2" placeholder="********" class="input-log" name="pass_repeat"
							   required="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}">
						
						<input type="submit" class="logIn-btn" value="Inregistrare" id="submitBtn">
					</form>
				</div>
				<br/>
				<br/>
		...
		<script>
			...
			{
				var inputLog = document.getElementById("password2");
