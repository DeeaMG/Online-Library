...
<html lang="en">
    ...
    <body>
		<div class="page">
            ...
            <main>
				...
				<div class="title">Autentificare</div>
                    <form class="orderContent" action="../php_includes/log_in_include.php" method="POST">
						<label class="info-log"><i class="fas fa-user"></i> Full Name </label>
						<input type="text" placeholder="E-mail/Username" class="input-log" name="userName">
						
						<label class="info-log"><i class="fas fa-lock"></i> Password </label>
						<div class="password">
							<input type="password" placeholder="********" class="inputLog-pass" id="inputLog-pass" name="password">
							<input type="checkbox" onclick="myFunc()" class="checkbox">
							<label id="visibility">Shown</label>
						</div>
		...
		<script>
			function myFunc ()
			{
				var input = document.getElementById("inputLog-pass");
				var vis = document.getElementById("visibility");
				
				if (input.type === "password")
				{
					input.type = "text";
					vis.innerHTML = "Hidden";
				}
				else 
				{
					input.type = "password";
			...
			var inputLog = document.getElementById("inputLog-pass");
