...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="../../../css/book_subtypes.css">
									...
									<div class="content">
										<div class="sidebar">
											<ul class="sidebar-links">
												<li class="types">
													<?php 
														echo '<a href="../audiobooks.php" class="bookTypes audiobooks">AUDIOBOOKS</a>';
														echo '<a href="../culinare.php" class="bookTypes culinare">CULINARE</a>';
														echo '<a href="#" class="bookTypes arta">ARTA, ARHITECTURA</a>';
														echo '<a href="../enciclopedii.php" class="bookTypes enciclopedii">ENCICLOPEDII</a>';
														echo '<a href="#" class="bookTypes reviste">REVISTE</a>';
														echo '<a href="../biografii_memorii_jurnale.php" class="bookTypes biografii">BIOGRAFII, MEMORII, JURNALE</a>';
														...
														echo '<a href="../romania.php" class="bookTypes romania">ROMANIA</a>';
