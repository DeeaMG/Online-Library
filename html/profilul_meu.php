...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../css/profilul_meu.css">
    ...
    <body>
		<div class="page">
            ...
            <main>
                <div class="container">
					<div class="detalii_cont">
						<div class="wr-detcont">
							<div class="wraper_img">
								<div class="img_container">
									<img src="../images/profile/cat2.jpg" class="profile_photo" alt="Image not found"/>
								</div>
								<div class="change_photo" style=""><i class="fas fa-pen"></i></div>
							</div>
							<div class="wraper-content">
								<form class="content-form" method="POST">
									<label class="content-label"> Nume: Blablabla </label>
									<label class="content-label"> E-mail: Lalalala </label>
									<label class="content-label"> Telefon: 0000000000 </label>
								</form>
							</div>
						</div>
						<div class="butt-delimiter">
							<button>Administreaza datele tale</button>
						</div>
					</div>
				</div>
            </main>
